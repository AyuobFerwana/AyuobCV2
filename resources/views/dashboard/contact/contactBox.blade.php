            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body p-0">
                    <div class="mailbox-controls">
                        ...
                        <!-- /.btn-group -->
                        <button type="button" onclick="window.location.href='{{ route('contactBox') }}'" class="btn btn-default btn-sm">
                        ...
                        <table class="table table-hover table-striped">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="mailbox-name"><a href="{{ route('readMess' ,['message'=>$mess->id]) }}">{{ $mess->first_name . ' ' .
                                            $mess->last_name }}</a></td>
